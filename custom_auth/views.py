...
class Dashboard(LoginRequiredMixin, generic.TemplateView):
    ...
    url_list = {
                ...
                'url_4':['loan_collection_list', 'Loan Collection', 'fa fa-check-square-o', 'Here all loan collection list'],
                'url_5':['loan_received_list', 'Loan Received', 'fa fa-cart-arrow-down', 'Here all loan receive list'],
